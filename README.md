...
# 📖 Modern UI/UX GPT-3 <a name="about-project"></a>
...
In this project of the Modern UI/UX GPT-3 application, I set up the environment and tools needed to develop a React application.
...
![Modern UI/UX GPT-3](https://github.com/Yidnekachew-cmd/GPT-3/assets/104775335/c39b1a85-9433-46ce-9388-8f6380bcf20d)
...
Feel free to check the [issues page](https://github.com/Yidnekachew-cmd/GPT-3/issues).
...
--> I would like to thank the  [JAVASCRIPTMASTERY]( https://www.jsmastery.pro/ ) team for allowing me to work on this Modern UI/UX GPT-3 project.
